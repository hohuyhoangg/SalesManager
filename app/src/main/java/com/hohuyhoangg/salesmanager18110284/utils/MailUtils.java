...
public class MailUtils {
   ...
   static final String AUTH_MAIL_ADDRESS = "hoanghh.dev@gmail.com";
   static final String AUTH_MAIL_USERNAME = "hoanghh.dev";
   static final String AUTH_MAIL_PASSWORD = "Hohuyhoang231200";
