...
CREATE TABLE IF NOT EXISTS `PRODUCT` (
	...
	`PRICE_ORDER` DECIMAL(19, 2) NOT NULL,			--   BÁN
...
CREATE TABLE IF NOT EXISTS `BILL` (
    ...
    `PRICE_PRODUCT` DECIMAL(19, 2) NOT NULL,
     `PRICE_DELIVERY` DECIMAL(19, 2) NOT NULL,
...
ALTER TABLE `BILL_DETAIL` ADD CONSTRAINT `FK_BILL_DETAIL_USER_ID` FOREIGN KEY (`BILL_ID`) REFERENCES `BILL`(`BILL_ID`);
